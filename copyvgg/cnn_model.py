...
class CNNModel(object):
    ...
    def build_model(self, input_images, input_images2, vgg_path):
        self.train_mode = tf.placeholder(tf.bool)
        self.vgg = vgg19.Vgg19(vgg_path, dropout=self.keep_prob, trainable=True)
        self.vgg.build(input_images, input_images2, self.train_mode)
        self.output1 = self.vgg.relu7
        self.output2 = self.vgg.relu7_copy
