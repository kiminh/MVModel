...
if __name__ == '__main__':
    ...
    # metric_all_npy2txt('/home2/shangmingyang/projects/shapenet/lxh/55/test_normal')
    # PR_csv2txt('/home/shangmingyang/wuque/projects/evaluator/mvmodel.pr-739.csv')
    # metric_all_npy2txt('/home2/shangmingyang/projects/shapenet/lxh/55/test_normal')
    metric_all_npy2txt('/home2/shangmingyang/projects/smy/shapenet/test_normal')
    #metric_all_npy2txt('/home1/shangmingyang/projects/evaluator/wxy/shapenet/train_normal')
    #plt.show()
