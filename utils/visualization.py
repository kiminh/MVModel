...
if __name__ == '__main__':
    ...
    show_attention('../ignore/data/attention_weights_seq_init.npy', model_index=554)
    # show_attention('../ignore/data/attention_weights_seq_init.npy', model_index=10)
    # show_attention('../ignore/data/attention_weights_seq_init.npy', model_index=715)
    plt.show()
