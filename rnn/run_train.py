...
train_cmd_base = 'python train.py --train=True --n_hidden=128 --decoder_embedding_size=256 --n_views=12 --use_lstm=False --training_epoches=100 --save_epoches=1 --learning_rate=0.0001 --batch_size=32 --n_max_keep_model=100 '
