...
train_cmd_base = 'python train.py --n_hidden=128 --decoder_embedding_size=256 --n_views=8 --use_lstm=False --keep_prob=1.0 --training_epoches=200 --save_epoches=1 --learning_rate=0.0001 --batch_size=32 --n_max_keep_model=200 '
...
data_paths = {"modelnet10": ["/home3/lhl/tensorflow-vgg-master-total/feature/train_12p_vgg19_epo48_do05_sigmoid7_feature_class10.npy", "/home3/lhl/modelnet10_v2/feature10/train_labels_modelnet10.npy", "/home3/lhl/tensorflow-vgg-master-total/feature/test_12p_vgg19_epo48_do05_sigmoid7_feature_class10.npy", "/home3/lhl/modelnet10_v2/feature10/test_labels_modelnet10.npy", "/home1/shangmingyang/data/3dmodel/trained_seq_mvmodel/modelnet10/", "modelnet10.csv"],
                ...
                "shapenet55": ["/home3/lhl/tensorflow-vgg-master-shapenet-color/feature/train_feature_SNC55_epo26.npy", "/home1/shangmingyang/data/3dmodel/shapenet/shapenet55_v1_train_labels.npy", "/home3/lhl/tensorflow-vgg-master-shapenet-color/feature/test_feature_SNC55_epo26.npy", "/home1/shangmingyang/data/3dmodel/shapenet/shapenet55_v1_test_labels.npy", "/home1/shangmingyang/data/3dmodel/trained_seq_mvmodel/shapenet55_color_0.0001_1.0", "shapenet55.csv"]}
...
#if args.train == "True":
    #train_cmd = train_cmd + " --train=True"
#else:
    #train_cmd = train_cmd + " --train=False"
