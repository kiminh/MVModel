...
#tf.flags.DEFINE_string("train_feature_file", "/home3/lhl/tensorflow-vgg-master-total/feature/train_12p_vgg19_epo49_do05_sigmoid7_feature_class10.npy", "vgg-sigmoid feature")
tf.flags.DEFINE_string("train_feature_file", "/home3/lhl/modelnet10_v2/feature10/train_feature_modelnet10_epo10_vgg40.npy", "vgg-sigmoid feature")
...
tf.flags.DEFINE_string("test_feature_file", "/home3/lhl/modelnet10_v2/feature10/test_feature_modelnet10_epo10_vgg40.npy", "test vgg-sigmoid feature")
...
def multiview(fcs, n_views=12):
    fcs2 = np.zeros(shape=[fcs.shape[0], 3, fcs.shape[2]])
