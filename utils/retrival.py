...
if __name__ == '__main__':
    ...
    generate_distance_test2test('/home1/shangmingyang/data/3dmodel/mvmodel_result/retrival/test_hidden.npy', '/home1/shangmingyang/data/3dmodel/mvmodel_result/retrival/test_test_euclidean')
